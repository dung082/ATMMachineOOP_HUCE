...
import Controller.NhapSTKCtrl;

/**
 *
 * @author Asus
 */
public class NhapSTKForm extends javax.swing.JFrame {

    String id;
    String mk;
    String id2;
    public NhapSTKForm(String id,String mk) {
        initComponents();
        this.id = id;
        this.mk = mk;
        ...
        NhapSTKCtrl ck = new NhapSTKCtrl();
        ck.setCk(txtstk, btnxn, btntrove, id, mk,cb1, this);
    ...
    private void initComponents() {
        ...
        cb1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A", "B", "C", "D", "E", "F" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(57, 57, 57)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtstk, javax.swing.GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE)
